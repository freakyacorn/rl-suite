...
class Agent:
    ...
    def train(self, environment):
        ...
        if self.training_round == 0:
            ...
            greedy_reward = self.__greedy_reward(
                new_states, environment.get_possible_actions(states=new_states)
            )
    ...
    def choose_actions(self, states, possible_actions):
        ...
        if self.training_round == 0:
            ...
            actions = self.policy.choose(
                states, possible_actions, self.brain, self.training_round
            )
